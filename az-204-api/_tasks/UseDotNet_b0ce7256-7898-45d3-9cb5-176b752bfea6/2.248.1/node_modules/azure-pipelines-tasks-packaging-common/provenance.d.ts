...
export declare class ProvenanceHelper {
    static CreateSessionRequest(feedId: string): SessionRequest;
    static GetSessionId(feedId: string, project: string, protocol: string, baseUrl: string, handlers: VsoBaseInterfaces.IRequestHandler[], options: VsoBaseInterfaces.IRequestOptions): Promise<string>;
