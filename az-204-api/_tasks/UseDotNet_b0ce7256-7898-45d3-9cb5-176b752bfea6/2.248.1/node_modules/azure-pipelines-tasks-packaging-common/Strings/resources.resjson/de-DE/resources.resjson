{
  ...
  "loc.messages.Error_NoMatchingFilesFoundForPattern": "Keine mit dem Suchmuster übereinstimmenden Dateien gefunden: %s",
  ...
  "loc.messages.Info_GotAndMaskAuth": "Das Authentifizierungstoken wurde abgerufen. Es wird als Geheimnis festgelegt, sodass es nicht im Konsolenprotokoll gedruckt wird.",
