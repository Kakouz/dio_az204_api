{
  ...
  "loc.messages.Error_NuGetToolInstallerFailer": "No se pudo instalar la herramienta: %s",
  ...
  "loc.messages.Info_GotAndMaskAuth": "Se ha obtenido el token de autenticación y se ha establecido como secreto para que no se imprima en el registro de la consola.",
