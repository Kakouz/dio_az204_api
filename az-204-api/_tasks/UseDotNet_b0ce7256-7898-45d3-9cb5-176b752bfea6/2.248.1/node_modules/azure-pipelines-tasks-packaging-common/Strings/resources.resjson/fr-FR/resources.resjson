{
  ...
  "loc.messages.Error_NoMatchingFilesFoundForPattern": "Aucun fichier correspondant n’a été trouvé avec le modèle de recherche : %s",
  ...
  "loc.messages.Info_GotAndMaskAuth": "Le jeton d’authentification a été obtenu, il est défini comme secret afin qu’il ne soit pas affiché dans le journal de la console.",
