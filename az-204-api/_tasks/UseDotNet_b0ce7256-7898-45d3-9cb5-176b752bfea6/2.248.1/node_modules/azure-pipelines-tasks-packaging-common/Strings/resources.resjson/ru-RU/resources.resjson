{
  ...
  "loc.messages.Info_GotAndMaskAuth": "Получен токен проверки подлинности, выполняется установка его в качестве секрета, чтобы он не печатались в журнале консоли",
