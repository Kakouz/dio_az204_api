{
  "loc.messages.Error_ApiKeyNotSupported": "DotNetCore non supporta attualmente l’uso di una chiave API crittografata.",
  ...
  "loc.messages.Info_GotAndMaskAuth": "Il token di autenticazione è stato acquisito e impostato come segreto in modo che non venga stampato nel log della console",
