...
export declare function GetExternalAuthInfoArray(inputKey: string): auth.ExternalAuthInfo[];
...
export declare function isOnPremisesTfs(): boolean;
export declare function isWindowsAgent(): boolean;
