...
export declare class NuGetXmlHelper implements INuGetXmlHelper {
    private _nugetConfigPath;
    constructor(_nugetConfigPath: string);
    ...
    private _addCredentialsToSource;
    private _removeSourceCredentials;
    /**
     ...
     */
    private static _validateXmlIsConfiguration;
    /**
     ...
     */
    private static _getOrCreateLastElement;
    private static _updateXmlFile;
    private static _nuGetEncodeElementName;
    private static _nuGetEncodeCharater;
}
